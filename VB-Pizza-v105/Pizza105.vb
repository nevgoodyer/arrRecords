Public Class Pizza105
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        CalcTotalPrice()
    End Sub
    Private Sub CheckBlank(TxtBoxName)
        'check FirstName is not blank.
        If TxtBoxName.Text = "" Then
            MsgBox("This field can't be blank", MsgBoxStyle.Exclamation, "Empty field check")
            TxtBoxName.Focus()
            Exit Sub
        End If
    End Sub
    ...
    Private Sub TxtPhone_MaskInputRejected(sender As Object, e As MaskInputRejectedEventArgs) Handles txtPhone.Leave
        'check Phone is not blank.
        If Not Len(txtPhone.Text) = 12 Then
            MsgBox("Ensure the phone number has 10 digits", MsgBoxStyle.Exclamation, "Phone # Check")
            txtLastName.Focus()
